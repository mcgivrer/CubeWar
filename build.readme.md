...
> **NOTE**
> <br/>If a `.sdkmanrc` file exists,it will be used and applied to set the Java environment with the right JDK
...
project.build.jars=// Any JAR dependency
```
...
- **Value**: none
- **Description**: List the external java dependencies archives (JAR) separated with a ';'.
- **example**: `lib/test/junit-platform-console-standalone-1.10.1.jar;lib/my-own-dependency.jar`
